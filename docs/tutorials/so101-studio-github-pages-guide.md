...
<section class="book-hero">
  <div>
    ...
    <div class="hero-actions">
      <a class="button primary" href="{{ '/tutorials/so101-studio/first-run/' | relative_url }}">Robotu ilk kez çalıştır</a>
...
<section class="doc-section">
  ...
  <div class="chapter-grid">
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/setup/' | relative_url }}" data-reveal>
      <span>01</span><h3>Kurulum / Install</h3><p>Müşteri installer yolu, GitHub preview yolu ve robot runtime bağımlılıkları.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/first-run/' | relative_url }}" data-reveal>
      <span>02</span><h3>İlk Kullanım</h3><p>USB’leri taktım, Studio’yu açtım, kolları nasıl tanıtacağım?</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/hardware/' | relative_url }}" data-reveal>
      <span>03</span><h3>Robot ve Parçalar</h3><p>Follower, leader, servo, bus kartı, gripper ve autoplay montaj videoları.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/dashboard/' | relative_url }}" data-reveal>
      <span>04</span><h3>Dashboard</h3><p>Cockpit ekranları, readiness modeli ve local gateway bağlantısı.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/safety/' | relative_url }}" data-reveal>
      <span>05</span><h3>SafetyGate</h3><p>Passkey unlock, operation contract, süre limiti ve emergency stop modeli.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/api-keys/' | relative_url }}" data-reveal>
      <span>06</span><h3>API Key Vault</h3><p>Hugging Face ve agent sağlayıcı keyleri için maskeli ayar yüzeyi.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/dataset/' | relative_url }}" data-reveal>
      <span>07</span><h3>Dataset Kaydı</h3><p>LeRobot uyumlu episode, camera key ve kalite kontrol akışı.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/training/' | relative_url }}" data-reveal>
      <span>08</span><h3>Hugging Face Eğitim</h3><p>Training planı, model ailesi, output repo ve rollout öncesi uyumluluk.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/agent/' | relative_url }}" data-reveal>
      <span>09</span><h3>Agent Modu</h3><p>Strands agent tool izinleri, tool stream ve fiziksel session scope.</p>
    </a>
    <a class="chapter-card" href="{{ '/tutorials/so101-studio/sources/' | relative_url }}" data-reveal>
      <span>10</span><h3>Kaynaklar</h3><p>Hashtag Robotics, Scout, Strands Robots, LeRobot ve SO-101 referansları.</p>
    </a>
  </div>
</section>
...
<nav class="next-prev" aria-label="Sonraki bölüm">
  <span></span>
  <a href="{{ '/tutorials/so101-studio/setup/' | relative_url }}">Sonraki: Kurulum / Install</a>
</nav>
