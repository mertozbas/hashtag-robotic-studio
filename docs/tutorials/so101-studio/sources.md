...
layout: default
book: so101
guide_section: sources
title: "Kaynaklar"
description: "SO-101, LeRobot, Strands Robots ve Hashtag Robotics kaynakları."
permalink: /tutorials/so101-studio/sources/
lang: tr
---
...
<nav class="next-prev" aria-label="Bölüm gezinme">
  <a href="{{ '/tutorials/so101-studio/agent/' | relative_url }}">Önceki: Agent Modu</a>
  <span></span>
</nav>
